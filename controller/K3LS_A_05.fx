...
float special : CONTROLOBJECT < string name = "K3LS_A_con_05.pmx"; string item = "specialeffect"; >;
float spaScale : CONTROLOBJECT < string name = "K3LS_A_con_05.pmx"; string item = "spaScale"; >;
float spaornormal : CONTROLOBJECT < string name = "K3LS_A_con_05.pmx"; string item = "spa<->normal"; >;
float specularStrength : CONTROLOBJECT < string name = "K3LS_A_con_05.pmx"; string item = "specularStrength"; >;
float metalness : CONTROLOBJECT < string name = "K3LS_A_con_05.pmx"; string item = "metalness"; >;
