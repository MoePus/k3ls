...
float reflectance : CONTROLOBJECT < string name = "K3LS_A_con_01.pmx"; string item = "reflectance"; >;
float special : CONTROLOBJECT < string name = "K3LS_A_con_01.pmx"; string item = "specialeffect"; >;
